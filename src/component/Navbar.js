...
function Navbar() {
    ...
    return (
        ...
        //     <nav>
        //         <i className="bx bx-menu"><IoMenuSharp /></i>
        //         <form action="#">
        //             <div className="form-input">
        //                 <input type="search" placeholder="Search..." />
        //                 <button className="search-btn" type="submit"><i className="bx bx-search"><IoSearch /></i></button>
        //             </div>
        //         </form>
        //         <input type="checkbox" id="theme-toggle" hidden />
        //         <label htmlFor="theme-toggle" className="theme-toggle" />
        //         <a href="#" className="notif">
        //             <i className="bx bx-bell"><MdNotificationsNone /></i>
